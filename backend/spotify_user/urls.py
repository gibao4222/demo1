...
from .views import  CurrentUserView, FollowArtistView, SingerSearchView, SongSearchView, SpotifyUserViewSet, UserAlbumViewSet, UserSearchView, UserSingerViewSet, PlaylistSearchView, AlbumSearchView
