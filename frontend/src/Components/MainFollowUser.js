...
//       try {
//         console.log("Đang lấy thông tin user với userId:", userId);
//         const response = await axios.get(`http://127.0.0.1:8000/api/users/users/${userId}/`);
//         console.log("Phản hồi từ API user:", response.data);
...
//   //         }
//   //       );
//   //       console.log("Phản hồi từ POST:", response.data); // Log chi tiết dữ liệu trả về
...
//       console.log("Status từ POST:", response.status);
//       if (response.status === 200 || response.status === 201) {
//         toast.success(response.data.thông_báo || "Đã thêm vào danh sách theo dõi.");
//         setIsFollowing(true);
//       } else {
