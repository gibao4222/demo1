    ...
    <div className="flex flex-column items-center">
        <div className="flex items-center">
            <button className="mr-4 mb-2">
                <img src="./icon/Shuffle_S.png"/>
            </button>
            <button className="mr-4">
                <img src="./icon/Component2.png"/>
            </button>
            <button className="mr-4">
                <img src="./icon/Component1.png"/>
            </button>
            <button className="mr-4">
                <img src="./icon/Component3.png"/>
            </button>
            <button className="mr-4">
                <img src="./icon/Repeat_S.png"/>
            </button>
        </div>
   ...
   <div className="flex items-center">
        <div className="flex items-center">
            <button className="mr-1">
                <img src="./icon/Queue_XS.png"/>
            </button>
            <button className="mr-1">
                <img src="./icon/Devices_XS.png"/>
            </button>
            <button className="mr-1">
                <img src="./icon/Volume_XS.png"/>
            </button>
        </div>
